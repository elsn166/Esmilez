...
$conn = new mysqli($servername, $username, $password, $dbname);
            ...
            $datas = [];
        //iteration1
            $sql1 = "SELECT DISTINCT patient_base_id, centre_id, patient_id
                        FROM patient WHERE centre_id =6 ORDER BY patient_base_id DESC LIMIT 20";
         // yuvaraj add
        	  ...
        	  while($row1 = $result1->fetch_assoc()) {
        	      ...
        	      $pat_id = $row1['patient_id'];
        	      $cent_id = $row1['centre_id'];
        	      $pb_id = $row1['patient_base_id'];
        	      
        	   //   echo $pat_id.'-'.$cent_id.'<br>';
